...
TOKEN = '1446285733:AAHdEhSlccOXqVQaWzbg3gBXY0_P-ujnXm0'

THREADS_LIMIT = 200

chat_ids_file = 'chat_ids.txt'

ADMIN_CHAT_ID = 1056517040
...
def handle_message_received(message):
    ...
    if text == '🤖Информация':
        bot.send_message(chat_id, 'Создатель бота: @aradionov366\n<b>\n\nПо вопросам сотрудничества обращаться в ЛС к создателю бота\n\n Канал создателя скрипта: @simpleecchi</b>', parse_mode='HTML')
